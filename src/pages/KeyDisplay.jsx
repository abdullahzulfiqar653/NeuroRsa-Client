    ...
    <div>
      <div className="bg-[#0f2e3f] h-[100vh]">
        ...
        <div className=" w-full">
          <div className="overflow-y-auto bg-[#0f2e3f] self-stretch border-[#1B3D4F] border-[1px] border-solid box-border flex flex-col items-start justify-start  pb-[110px] pl-3 pr-[11px] gap-[17px] max-w-full mq800:pt-[23px] mq800:pb-5 mq800:box-border">
              ...
              <Formik>
                <Form className="select-none">
                  <Field
                    ...
                    value={keyText}
                    readOnly
                    className="w-full h-[460px] text-[#fff] bg-[#0B2837] overflow-y-auto border-none focus:outline-none focus:ring-0 border-[1px] border-[#1B3D4F]"
                  />
                </Form>
              </Formik>
            </div>
          </div>
          <div className="fixed bottom-0 left-0 right-0 flex justify-start items-end gap-5 px-[32px] py-4 bg-[#0f2e3f] border-t border-[#1B3D4F]">
            {keyType === "Private" ? (
              ""
            ) : (
